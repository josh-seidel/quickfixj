...
//			assertSessionIds();
	...
	/* This test is no longer needed, and is caught on compile-time instead of runtime. */
	/*
	 * private void assertSessionIds() { // This is a strange place for this test,
	 * but it wasn't convenient // to put it elsewhere. Bug #153
	 * ArrayList<SessionID> sessionIDs = acceptor.getSessions(); for (SessionID
	 * sessionID : sessionIDs) { Assert.assertTrue(sessionID instanceof SessionID);
	 * } }
	 */
